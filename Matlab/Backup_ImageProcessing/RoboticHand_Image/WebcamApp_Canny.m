...
% USER PARAMETERS
    ...
    img.hist_n = 9; % Total Number of Different Histogram Samples
...
%         title('Color Histogram Region of Interest');
        ...
        subplot(2,3,4);
        x = imcrop(hand,[st.BoundingBox(1),st.BoundingBox(2),st.BoundingBox(3),st.BoundingBox(4)]);
        imshow(x);
        
%         H = fspecial('laplacian');
%         dd = imfilter(hand_g,H);
%         imshow(dd);
